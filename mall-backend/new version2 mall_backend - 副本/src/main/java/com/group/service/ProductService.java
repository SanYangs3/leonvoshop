...
public interface ProductService {
    ...
    */
    ...
    /*
    新增：获取商家的低库存商品列表（库存 <= 5）
     */
    List<Product> getLowStockProductsByBusinessId(Integer bid);

    /*
    新增：统计商家的低库存商品数（库存 <= 5）
     */
    Integer countLowStockProductsByBusinessId(Integer bid);


    /*
    新增：商家修改商品信息
     */
    boolean updateProduct(Integer bid, Product product);
}