...
export default {
  ...
  data() {
    return {
      ...
      // 分类数据
      categories: [
        { id: 1, name: '平板', count: 10 }, // 改为平板图标
        { id: 2, name: '显示器', count: 8 },
        { id: 3, name: '配件', icon: '🎧', count: 8 },
        { id: 4, name: '商务本', icon: '💼', count: 7 },
        { id: 5, name: '轻薄本', icon: '📘', count: 5 },
        { id: 6, name: '打印机', icon: '🖨️', count: 5 },
        { id: 7, name: '轻薄笔记本', icon: '💻', count: 4 }, // 改为笔记本电脑图标
        { id: 8, name: '台式机', icon: '🖥️', count: 3 },
        { id: 9, name: '游戏本', icon: '🎮', count: 2 },
        { id: 10, name: '游戏台式机', icon: '🕹️', count: 2 }, // 改为游戏手柄图标
        { id: 11, name: '性能本', icon: '⚡', count: 1 }, // 改为闪电图标
        { id: 12, name: '二合一笔记本', icon: '💻', count: 1 },
        { id: 13, name: '一体机', icon: '🖥️', count: 1 },
        { id: 14, name: '手机', icon: '📱', count: 1 },
        { id: 15, name: '台式工作站', icon: '⚙️', count: 1 },
        { id: 16, name: '设计本', icon: '🎨', count: 1 } // 改为调色板图标
      ],
