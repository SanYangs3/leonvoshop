...
.login-view::before {
  ...
  bottom: 0;
  background:
      radial-gradient(circle at 20% 30%, rgba(75, 108, 183, 0.05) 0%, transparent 50%),
      radial-gradient(circle at 80% 70%, rgba(75, 108, 183, 0.05) 0%, transparent 50%);
  z-index: 1;
}
...
.login-box::before {
  ...
  right: 0;
  height: 4px;
  background: linear-gradient(90deg, #4b6cb7 0%, #90caf9 100%);
}
