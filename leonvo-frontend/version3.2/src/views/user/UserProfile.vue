      ...
      <div class="profile-box">
        ...
        <div class="profile-content">
          ...
          <div class="form-section">
             <h3><span class="section-icon">🎓</span> 学生认证</h3>
             <div class="student-verify-card">
               <div v-if="studentStatus === 'certified'" class="verify-status success">
               ...
               <div v-else-if="studentStatus === 'pending'" class="verify-status pending">
                 <span class="status-icon">⏳</span>
                 <div class="status-text">
                   <h4>认证审核中</h4>
                   <p>我们正在审核您的学生身份，请耐心等待</p>
                 </div>
               </div>
               
               <div v-else class="verify-form">
                 <p class="verify-desc">完成学生认证，享受教育优惠价格和专属特权</p>
                 
                 <div class="form-group">
                   <label>学校名称</label>
                   <input type="text" v-model="studentForm.school" placeholder="请输入学校全称" class="form-input">
                 </div>
                 
                 <div class="form-group">
                   <label>学号</label>
                   <input type="text" v-model="studentForm.studentId" placeholder="请输入学号" class="form-input">
                 </div>
                 
                 <div class="form-group">
                   <label>学生证照片</label>
                   <div class="upload-box" @click="$refs.studentCardInput.click()">
                 ...
                 <button class="btn-verify-submit" @click="submitStudentVerify" :disabled="verifying">
                   {{ verifying ? '提交中...' : '提交认证' }}
                 </button>
               </div>
             </div>
