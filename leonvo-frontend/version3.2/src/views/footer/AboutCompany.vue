<template>
  <div class="footer-page">
    <div class="page-header">
      ...
      <h1>🏢 公司简介</h1>
      <p class="page-subtitle">绿色科技，智慧生活 - 泡泡联盟的愿景与使命</p>
    </div>
    ...
    <div class="page-content">
      <div class="company-overview">
        ...
        <p class="company-intro">
          我们是一家致力于绿色科技产品研发与销售的创新型公司。秉承"科技让生活更美好"的理念，
          我们将环保理念融入每一个产品，为用户提供高品质、环保的科技产品。
        </p>
      </div>
      ...
      <div class="mission-vision">
        <div class="mission-card">
          ...
          <div class="card-content">
            <h3>我们的使命</h3>
            <p>通过创新的绿色科技产品，为用户带来更健康、更环保的生活方式，
              推动科技行业的可持续发展。</p>
          </div>
        </div>
        <div class="vision-card">
          ...
          <div class="card-content">
            <h3>我们的愿景</h3>
            <p>成为全球领先的绿色科技品牌，让每一个家庭都能享受科技带来的便利，
              同时为地球环境保护贡献力量。</p>
          </div>
        </div>
      </div>
      ...
      <div class="company-history">
        <div class="section-header">
          <h2><span class="icon">📅</span> 发展历程</h2>
        </div>
        <div class="timeline">
      ...
      <div class="eco-commitment">
        <div class="section-header">
          <h2><span class="icon">🌱</span> 环保承诺</h2>
        </div>
        <div class="eco-cards">
          <div class="eco-card">
